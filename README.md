...
[![Version](https://img.shields.io/badge/version-0.1.4-blue.svg)](https://github.com/SysAdminDoc/AI-Usage_Tracker/releases)
...
- **API-first usage collection** — reads Claude `api/organizations/{orgId}/usage` and Codex `backend-api/wham/usage` for actual usage windows, with page scrapers retained only as fallback.
...
1. Download `AI-Usage-Tracker-chrome-v0.1.4.zip` from the [Releases page](https://github.com/SysAdminDoc/AI-Usage_Tracker/releases/latest).
2. Unzip it anywhere.
...
1. Download `ai-usage-tracker-firefox-v0.1.4.xpi` from the [Releases page](https://github.com/SysAdminDoc/AI-Usage_Tracker/releases/latest).
