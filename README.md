...
[![Version](https://img.shields.io/badge/version-0.1.5-blue.svg)](https://github.com/SysAdminDoc/AI-Usage_Tracker/releases)
...
- **API-first usage collection** — reads Claude `api/organizations/{orgId}/usage` and Codex `backend-api/wham/usage` for actual usage windows, with Claude stream updates and page scrapers retained as fallbacks.
...
1. Download `AI-Usage-Tracker-chrome-v0.1.5.zip` from the [Releases page](https://github.com/SysAdminDoc/AI-Usage_Tracker/releases/latest).
2. Unzip it anywhere.
...
1. Download `ai-usage-tracker-firefox-v0.1.5.xpi` from the [Releases page](https://github.com/SysAdminDoc/AI-Usage_Tracker/releases/latest).
