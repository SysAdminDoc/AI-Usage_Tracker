...
- [x] Streamed `message_limit` payloads are bridged into extension/userscript local storage without consuming the page response
- [x] Streamed fractional utilization updates merge with existing Claude buckets and preserve plan/org metadata
- [x] Stream source labels and parser smoke coverage were added
- [x] Visible widget, popup, and options version labels were resynced with package versions
