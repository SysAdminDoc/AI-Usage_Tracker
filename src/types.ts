...
export interface ProviderSnapshot {
  ...
  lastErrorSchemaVersion?: number | null;
  lastErrorSchemaFingerprint?: string | null;
  ...
  stale?: boolean;
  staleReason?: 'schema-drift' | 'source-disagreement' | 'refresh-failed' | string | null;
  schemaVersion?: number | null;
  schemaFingerprint?: string | null;
  schemaExpectedFingerprint?: string | null;
